sap.ui.define([
		...
		return BaseObject.extend("opensap.manageproducts.controller.ListSelector", {
			 ...
			 * @return {ml.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
